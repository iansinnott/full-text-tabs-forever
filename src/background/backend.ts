...
export interface Backend {
  ...
  search: RemoteProc<{ query: string, limit?: number, offset?: number, orderBy: "updatedAt" | "rank", preprocessQuery?: boolean }, { ok: boolean, results: ResultRow[], count?: number, perfMs: number, query: string }>;
